...
class TryTestingAssembly(TestCase):
    ...
    def test_assembly_filter(self):
        tests = {
            "Which subjects are heavier than 0.8 kg and lighter than 2 kg?": "The subjects are: <br> &nbsp;&nbsp;&nbsp;&nbsp;- GPS receiver unit <br> &nbsp;&nbsp;&nbsp;&nbsp;- Propulsion system control unit <br> &nbsp;&nbsp;&nbsp;&nbsp;- Receiver unit <br> &nbsp;&nbsp;&nbsp;&nbsp;- Magnetometer <br> &nbsp;&nbsp;&nbsp;&nbsp;- Primary thruster <br> &nbsp;&nbsp;&nbsp;&nbsp;- Base plate <br>  ",
            "Which subjects are heavier than 10 kg?": "The subjects are: <br> &nbsp;&nbsp;&nbsp;&nbsp;- EPS regulators and converters unit <br> &nbsp;&nbsp;&nbsp;&nbsp;- Propellant tank <br> &nbsp;&nbsp;&nbsp;&nbsp;- Sensor <br>",
